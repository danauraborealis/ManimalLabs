...
OUT = Path(__file__).parent / "boiler_windows.json"
...
def main():
        ...
        for o in sf.objects.values():
            ...
            try:
                ...
                if key not in node_cache:
                    ...
                    pass  # no surgery — WindowBreaker parsed straight with the SPT typetree
    ...
    OUT.write_text(json.dumps({"source": "retail current (post-1.0) labs level74 WindowBreakers", "components": results}, indent=1))
